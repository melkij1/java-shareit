...
@WebMvcTest(controllers = main.java.ru.practicum.shareit.booking.controllers.BookingController.class)
class BookingControllerTest {

    @MockBean
    private main.java.ru.practicum.shareit.booking.service.BookingService bookingService;
    ...
    void saveNewBooking() throws Exception {
        when(bookingService.save(any(), anyLong())).thenReturn(bookingDtoOut);
    ...
    void approve() throws Exception {
        ...
        bookingDtoOut.setStatus(BookingStatusEnum.APPROVED);
